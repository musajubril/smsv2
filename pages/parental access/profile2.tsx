        ...
        <div className=' md:justify-between justify-center flex px-14 py-2  '>
         ...
         <div className=' sm:block  md:flex justify-center items-center h-[70%]'>
             ...
             <div className=' relative'>
                   <div className=' border border-[#0065C2] bg-white-100 py-2  flex gap-3 items-center px-3 rounded-lg shadow'>
                       <div className=' w-12 h-12'><img src="./Avatars (1).png" alt="" />
                          ...
                          <div className=' flex flex-col'>
                             ...
                             <div className='border border-[#0065C2] rounded-full p-1 text-xs text-[#0065C2] absolute right-3'>
                               <BsCheck />
                             </div>
                     </div>
                     </div>
