        ...
        <div className=' flex justify-center items-center flex-col p-4 h-screen '>
          ...
          <div className='flex flex-col gap-5 justify-center items-center'>
            ...
            <div className=' flex flex-col gap-2 text-center '>
                <h1 className='text-3xl font-semibold text-[BABABA]'><span className='text-[#000D19]'>Login.</span>Parents/Guardian</h1>
                <p>Thank you for bringing your wards/children to our school</p>
          ...
          <div className=''>
                ...
                <Button text={'Login'} disabled={false} onClick={undefined} intent='primary' size='base' />
        </div>

          </div>
          <div className='pt-3 font-semibold text-base text-[#878787]'>Forgot your password?<span className=' text-[#0065C2]'>Reset here</span></div>
